            ...
            <div class="modal-body tabbable">
                <div class="transferOwnershipEditContents">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select class="select2-container columnsSelect" id="related_modules"{if $MODULE neq 'Contacts'} data-validation-engine="validate[required]"{/if} data-placeholder="{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}" multiple="" name="related_modules[]" style="width: 350px;">
                ...
                <div class="transferOwnershipProgressContainer hide" style="padding: 10px 15px 0;">
                    ...
                    <button type="button" class="btn btn-warning js-cancel-transfer-ownership-progress">{vtranslate('LBL_CANCEL', $MODULE)}</button>
                </div>
</div>
