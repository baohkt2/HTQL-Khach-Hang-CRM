...
jQuery.Class(
  ...
  },
  {
    ...
    getUiTypeModel: function () {
      ...
      var moduleUiTypeClassName =
        window[currentModule + "_" + typeClassName + "_Field_Js"];
      var BasicUiTypeClassName =
        window["Vtiger_" + typeClassName + "_Field_Js"];
    ...
    addValidationToElement: function (element) {
      ...
      addValidationToElement
        ...
        .attr(
          "data-specific-rules",
          JSON.stringify(this.getData().specialValidator),
        );
      return element;
    },
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      ...
      html += '">';
      html +=
        '<input name="popupReferenceModule" type="hidden" value="' +
        referenceModules[0] +
        '"/>';
      html += '<div class="input-group ">';
      html +=
        '<input class="autoComplete inputElement sourceField" type="search" data-fieldtype="reference" name="' +
        this.getName() +
        '"';
      var reset = false;
      if (value) {
      ...
      html +=
        '<span class="input-group-addon relatedPopup cursorPointer" title="' +
        referenceModules[0] +
        '">';
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      ...
      var html =
        '<select class="select2 inputElement inlinewidth" name="' +
        this.getName() +
        '" id="field_' +
        this.getModuleName() +
        "_" +
      ...
      if (
        typeof pickListValues[" "] == "undefined" ||
        pickListValues[" "].length <= 0 ||
        pickListValues[" "] != "Select an Option"
      ) {
        html +=
          '<option value="">' +
          app.vtranslate("JS_SELECT_OPTION") +
          "</option>";
      }
      ...
      for (var option in pickListValues) {
        ...
        if (picklistColors) {
          ...
          if (picklistColors[option]) {
            className =
              "picklistColor_" + fieldName + "_" + option.replace(" ", "_");
      ...
      if (picklistColors) {
        ...
        for (option in picklistColors) {
          ...
          if (picklistColor) {
            ...
            html +=
              className +
              "{white: #ffffff !important; background-color: #337ab7 !important;}";
          }
        }
        html += "<\style>";
      }
...
Vtiger_Field_Js(
  "Vtiger_Documentsfolder_Field_Js",
  {},
  {
    /**
     * Function to get the pick list values
...
(Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<select class="select2 inputElement" multiple name="' +
        this.getName() +
        '[]" id="field_' +
        this.getModuleName() +
        "_" +
    ...
    {},
    {
      ...
      isChecked: function () {
        ...
        if (
          ...
          value == "1" ||
          (value &&
            (value.toLowerCase() == "on" || value.toLowerCase() == "yes"))
        ) {
          return true;
        }
        return false;
      ...
      getUi: function () {
        var html =
          ...
          this.getName() +
          '"/><input class="inputElement" type="checkbox" name="' +
          this.getName() +
          '" ';
        if (this.isChecked()) {
          html += "checked";
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      ...
      var html =
        '<div class=""><div class="input-group date">' +
        '<input class="inputElement dateField form-control" type="text" data-rule-date="true" data-format="' +
        this.getDateFormat() +
        '" name="' +
        this.getName() +
        '" value="' +
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        ...
        '<input class="timepicker-default form-control inputElement" type="text" data-rule-time="true" data-format="' +
        this.getTimeFormat() +
        '" name="' +
        this.getName() +
        '" value="' +
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<textarea class="input-xxlarge form-control inputElement" name="' +
        this.getName() +
        '" value="' +
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<div class="input-group percentage-input-group">' +
        '<input type="text" class="form-control inputElement percentage-input-element" name="' +
        this.getName() +
        '" value="' +
        this.getValue() +
        '" step="any" data-rule-' +
...
Vtiger_Field_Js(
  ...
  {},
  {
    ...
    getUi: function () {
      var html =
        '<input class="getPopupUi inputElement" type="text" name="' +
        this.getName() +
        '" data-label="' +
        this.get("label") +
...
Vtiger_Field_Js(
  "Vtiger_Phone_Field_Js",
  {},
  {
    getUi: function () {
      var html =
        '<input class="inputElement phoneField" type="text" name="' +
        this.getName() +
        '" data-label="' +
        this.get("label") +
        '" data-rule-' +
