    ...
    <div id="gantEditorTemplates" style="display:none;">
        <div class="__template__" type="TASKSEDITHEAD"><!--
            <table class="gdfTable" cellspacing="0" cellpadding="0">
              ...
              <tr style='height:50px'>
                ...
                <th class="gdfColHeader" style="width:50px;text-align:center;" >{vtranslate('LBL_COLOR', $MODULE)}</th>
                ...
                <th class="gdfColHeader cursorPointer" style="width:80px;text-align:center;" data-name="name" data-text="{vtranslate('LBL_TASK_NAME', $PROJECT_MODULE)}">{vtranslate('LBL_TASK_NAME', $PROJECT_MODULE)}</th>
        ...
        <div class="__template__" type="TASKROW"><!--
            <tr taskId="(#=obj.id#)" class="taskEditRow" level="(#=level#)">
              ...
              <td class="gdfCell noClip" align="center"><div class="taskStatus cvcColorSquare" status="(#=obj.number#)"></div></td>
        ...
        jQuery(document).ready(function () {
            ...
            container.on('click', '.gdfColHeader', function (e) {
                ...
                if (name) {
                    ...
                    var data = JSON.parse($("#projects").val());
