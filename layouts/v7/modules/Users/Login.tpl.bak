    ...
    <div class="login-container">
        ...
        <div class="login-panel-left">
            <div class="welcome-badge">
                ...
                H? TH?NG QU?N LÝ KHÁCH HÀNG
            </div>

            <div class="marketing-title">
                Chào m?ng d?n v?i<br><span>{$BRANDING.app_name}</span>
            </div>

            <div class="marketing-description">
                N?n t?ng qu?n lý quan h? khách hàng toàn di?n, giúp t? ch?c c?a b?n t?i uu hóa quy trình làm vi?c và phát tri?n b?n v?ng.
            </div>

            <div class="feature-grid">
                <div class="feature-card">
                    <div class="feature-icon blue">??</div>
                    <h4>Qu?n lý liên h?</h4>
                    <p>Theo dõi và qu?n lý thông tin khách hàng, d?i tác hi?u qu?</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon cyan">??</div>
                    <h4>Tích h?p Email</h4>
                    <p>G?i và nh?n email tr?c ti?p trong h? th?ng CRM</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon green">??</div>
                    <h4>Báo cáo thông minh</h4>
                    <p>Phân tích d? li?u v?i bi?u d? tr?c quan, d? hi?u</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon purple">?</div>
                    <h4>T? d?ng hóa</h4>
                    <p>Quy trình làm vi?c t? d?ng, ti?t ki?m th?i gian</p>
                </div>
            </div>
        </div>
        ...
        <div class="login-panel-right">
            ...
            <div class="login-subheading">
                Nh?p thông tin tài kho?n d? truy c?p h? th?ng
            </div>
            ...
            <form method="POST" action="index.php" autocomplete="on">
                ...
                <div class="form-group">
                    <label class="form-label">Tên dang nh?p</label>
                    <div class="input-wrapper">
                        <input type="text"
                               name="username"
                               class="form-input"
                               placeholder="Nh?p tên dang nh?p"
                               required
                               autofocus
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <button type="button" class="password-toggle" onclick="togglePassword()" tabindex="-1" title="Hi?n/?n m?t kh?u">
            ...
            <div class="login-footer">
                <a href="forgotPassword.php">Quên m?t kh?u?</a>
            </div>

            <div class="login-copyright">
                <p>&copy; {$smarty.now|date_format:"%Y"} {$BRANDING.app_name}. B?n quy?n thu?c CUSC.</p>
            </div>
        </div>
    </div>
</div>
