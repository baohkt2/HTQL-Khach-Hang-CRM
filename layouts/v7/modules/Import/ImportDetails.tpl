...
<script type="text/javascript">
	jQuery(function () {
		jQuery(document)
			.off("click.importDetailOpen", ".import-details-container .importDetailRowClickable")
			.on("click.importDetailOpen", ".import-details-container .importDetailRowClickable", function (event) {
