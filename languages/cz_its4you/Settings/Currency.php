...
"Currency Name" => "Aktuální měna",
"Currency Code" => "Aktuální kód",
"LBL_ADD_RECORD" => "Přidat měnu",
"LBL_EDIT_CURRENCY" => "Editovat měnu",
"LBL_ADD_NEW_CURRENCY" => "Přidat novou měnu",
"LBL_CURRENCY_NAME" => "Název měny",
"LBL_CURRENCY_CODE" => "Kód měny",
"LBL_CURRENCY_SYMBOL" => "Symbol",
"LBL_CONVERSION_RATE" => "Konverzní kurz",
"LBL_ENTER_CONVERSION_RATE" => "Zadejte konverzní poměr",
"LBL_CURRENCY_STATUS_DESC" => "Zaškrtnutím checkboxu nastavíte měnu jako aktivní",
"LBL_TRANSFER_CURRENCY" => "Přenést měnu",
"LBL_CURRENT_CURRENCY" => "Aktuální měna",
...
"Czech Republic, Koruny" => "Česká republika, Koruny",
...
"JS_CURRENCY_DETAILS_SAVED" => "Detaily měny uloženy",
"JS_CURRENCY_DELETED_SUEESSFULLY" => "Měna byla úspěšně smazána",
);