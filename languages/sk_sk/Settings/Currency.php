...
"LBL_ADD_RECORD" => "Pridať novú menu",
"LBL_EDIT_CURRENCY" => "Upraviť Menu",
"LBL_ADD_NEW_CURRENCY" => "Pridať novú menu",
"LBL_CURRENCY_NAME" => "Mena",
"LBL_CURRENCY_CODE" => "Kód",
"LBL_CURRENCY_SYMBOL" => "Symbol",
"LBL_CONVERSION_RATE" => "Konverzný kurz",
"LBL_ENTER_CONVERSION_RATE" => "Úprava konverzného kurzu",
"LBL_CURRENCY_STATUS_DESC" => "Zaškrtnutím nastavíte menu ako aktívnu",
"LBL_TRANSFER_CURRENCY" => "Prevod Meny",
"LBL_CURRENT_CURRENCY" => "Aktuálne Meny",
...
"Currency Name" => "Aktuálna mena",
"Currency Code" => "Aktuálny kód",
);

$jsLanguageStrings = array(
"JS_CURRENCY_DETAILS_SAVED" => "Nová mena bola úspešne uložená",
"JS_CURRENCY_DELETED_SUEESSFULLY" => "Mena bola úspešne vymazaná",
);