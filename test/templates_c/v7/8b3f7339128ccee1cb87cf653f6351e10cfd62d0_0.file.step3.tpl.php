<?php
/* Smarty version 4.5.5, created on 2025-09-30 07:53:01
  from 'C:\xampp\htdocs\vtigercrm\layouts\v7\modules\Reports\step3.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_68db8c5d68a2e9_98875207',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8b3f7339128ccee1cb87cf653f6351e10cfd62d0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\layouts\\v7\\modules\\Reports\\step3.tpl',
      1 => 1752039682,
      2 => 'file',
    ),
  ),
...
function content_68db8c5d68a2e9_98875207 (Smarty_Internal_Template $_smarty_tpl) {
...
" /><input type="hidden" name="secondary_modules" value=<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['SECONDARY_MODULES']->value);?>
 /><input type="hidden" name="selected_fields" id="selected_fields" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('selected_fields'));?>
' /><input type="hidden" name="selected_sort_fields" id="selected_sort_fields" value=<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('selected_sort_fields'));?>
 /><input type="hidden" name="selected_calculation_fields" id="calculation_fields" value=<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['REPORT_MODEL']->value->get('calculation_fields'));?>
...
</strong></h4><br><span class="col-lg-12"><?php if (!(isset($_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELDS']->value))) {
$_smarty_tpl->_assignInScope('SELECTED_ADVANCED_FILTER_FIELDS', array());
}
$_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( 'AdvanceFilter.tpl' )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'ADVANCE_CRITERIA'=>$_smarty_tpl->tpl_vars['SELECTED_ADVANCED_FILTER_FIELDS']->value,'COLUMNNAME_API'=>'getReportFilterColumnName'), 0, true);
